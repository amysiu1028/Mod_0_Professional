...
// // Write a program that evaluates the status of the variables above, and
//  uses logic to print one of three possible messages:
...
if (goodDrivingRecord === true && age > 25) {
    ...
    console.log("You will need someone else to sign the rental")
}
...
// if (goodDrivingRecord === true && age > 25) {
//     console.log("You qualifty for a discount on your car rental")
// } else if (goodDrivingRecord === true || age > 25) {
//     console.log("You will pay full price")
// } else {
